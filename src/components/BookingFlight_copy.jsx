...
function BookingFlight_copy() {
  ...
  const { isSelected2 } = useReturnSelectedContext();
  ...
  const { tokenID } = useBetween(Share);
  ...
  const selectAirports = departureFlight.map((data) => {
    if (data.flightDetails.length >= 1) {
      data.flightDetails?.map((el) => {
        if (airlineNameArray.findIndex((x) => x === el.airline.name) === -1) {
  ...
  return (
    <div className="h-[100%] min-h-screen ">
      <div className="grid grid-rows-1 mx-2 lg:mx-40">
        <div className="my-4">
          <div className="flex justify-end items-center text-[#828282] bg-gray-200 mx-16 mb-4 rounded">
            <p className="mx-2">NFT : {nftName}</p>
            {/* <p className='mx-16 '>Route : BKK-CNX</p> */}
          </div>

          <div className="">
            <div className="flex flex-wrap w-auto md:justify-start justify-center mx-16">
              <div className="flex justify-start items-center border rounded-box bg-white lg:w-[45%]">
                <div className="flex flex-col ">
                  <div className="flex items-center">
                    <p className="mx-4 text-[#FAA819]">From</p>
                  ...
                  <p className="mx-4">{access.originCode}</p>
                ...
                <div className="flex flex-col">
                  <div className="flex items-center">
                    <p className="mx-4 text-[#FAA819]">To</p>
                  ...
                  <p className="mx-4">{access.destinationCode}</p>
                  <p className="mx-4 text-[#828282]">{findAirportCodeArr()}</p>
                </div>
              </div>

              <div className="flex justify-start items-center border rounded-box bg-white ml-2 lg:w-[40%]">
                <div className="flex flex-col">
                  <p className="mx-4 text-[#FAA819]">Departure</p>
                  <p className="mx-4">{moment(access.departureDate).format("DD-MMM-YYYY")}</p>
                  <p className="mx-4 text-[#828282]">{moment(access.departureDate).format("dddd")}</p>
                </div>
                ...
                {tripType === "O" ?  <p className="text-[#FAA819]">Oneway Trip</p> : 
                <div className="flex flex-col">
                  <p className="mx-4 text-[#FAA819]">Return</p>
                  <p className="mx-4">{moment(access.returnDate).format("DD-MMM-YYYY")}</p>
        ...
        <div className="">
          <div className="h-[100%] flex p-2 mx-4 lg:mx-10">
            <div className="w-[50%] h-[100%] mx-2">
              <>
                <div className="flex justify-center">
                  <div className="w-[100%] shadow-lg p-2">
                    <p className="text-md font-bold bg-gray-200">Select Flight (Departure)</p>
                    {typeTrip === "R"
                      ? airline && (
                          <>
                            <img className="w-100% p-2" src={src} alt="Icon" />
                            <p>{airline}</p>
                    ...
                    <div className="w-[100%] mt-4">
                      {typeTrip === "R" ? (
                        <p className="text-md font-bold bg-gray-200">Select Flight (Return)</p>
                      ) : null}

                      {typeTrip === "R"
                        ? airline2 && (
                            <>
                              <img className="w-100% p-2" src={src2} alt="Icon" />
                              <p>{airline}</p>
                              <div className="flex justify-between items-center">
                                <div className="">
                                  <div className="flex justify-start">
                              ...
                              <div className="my-2">
                                ...
                                <p className="text-center">{oneStopCity2}</p>
                                {oneStopCity2 ? (
                                  <div className="flex">
                                    <svg
                                      width=""
            ...
            <div className={isSelected ? `hidden` : `border w-full p-2`}>
              <p className="text-[#4E1311] border rounded text-md font-bold bg-gray-200">Select Flight (Departure)</p>
              <Card />
            </div>

            {typeTrip === "R" ? (
              <div className={isSelected ? `border w-full p-2` : `hidden`}>
                <p className="text-[#4E1311] border rounded text-md font-bold bg-gray-200">Select Flight (Return)</p>
                <Card2 />
              </div>
            ) : null}
          </div>
