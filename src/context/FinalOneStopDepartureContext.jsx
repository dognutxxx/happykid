  ...
  return (
    <FinalOneStopDepartureContext.Provider
      value={{
        ...
        setDepOneStopDepCityCode_s1,
        depOneStopDepCityCode_s2,
        setDepOneStopDepCityCode_s2,
        depOneStopDepCityName_s1,
        setDepOneStopDepCityName_s1,
        depOneStopDepCityName_s2,
        setDepOneStopDepCityName_s2,
        depOneStopArrCityCode_s1,
        setDepOneStopArrCityCode_s1,
        depOneStopArrCityCode_s2,
        setDepOneStopArrCityCode_s2,
        depOneStopArrCityName_s1,
        setDepOneStopArrCityName_s1,
        depOneStopArrCityName_s2,
        setDepOneStopArrCityName_s2,
        depOneStopAirlineCode_s1,
        setDepOneStopAirlineCode_s1,
        depOneStopAirlineCode_s2,
        setDepOneStopAirlineCode_s2,
        depOneStopAirlineName_s1,
        setDepOneStopAirlineName_s1,
        depOneStopAirlineName_s2,
        setDepOneStopAirlineName_s2,
        depOneStopFlightNumber_s1,
        setDepOneStopFlightNumber_s1,
        depOneStopFlightNumber_s2,
        setDepOneStopFlightNumber_s2,
        depOneStopOperatedAirlineCode_s1,
        setDepOneStopOperatedAirlineCode_s1,
        depOneStopOperatedAirlineCode_s2,
        setDepOneStopOperatedAirlineCode_s2,
        depOneStopOperatedAirlineName_s1,
        setDepOneStopOperatedAirlineName_s1,
        depOneStopOperatedAirlineName_s2,
        setDepOneStopOperatedAirlineName_s2,
        depOneStopDepartureDateTime_s1,
        setDepOneStopDepartureDateTime_s1,
        depOneStopDepartureDateTime_s2,
        setDepOneStopDepartureDateTime_s2,
        depOneStoparriveDateTime_s1,
        setDepOneStoparriveDateTime_s1,
        depOneStoparriveDateTime_s2,
        setDepOneStoparriveDateTime_s2,
        depOneStopRBD_s1,
        setDepOneStopRBD_s1,
        depOneStopRBD_s2,
        setDepOneStopRBD_s2,
